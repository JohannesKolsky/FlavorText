...
namespace FlavorText
{
    public class FlavorTextSettings : ModSettings
    {
        ...
        public static void DoWindowContents(Rect inRect)
        {
            ...
            numAllowedMissingIngredients = (int)listing_Standard.SliderLabeled("numAllowedMissingIngredients".Translate(numAllowedMissingIngredients), numAllowedMissingIngredients, 0, CompProperties_Flavor.MaxNumIngredientsFlavor - 1, labelPct: 0.7f, tooltip: "numAllowedMissingIngredientsTooltip".Translate());
            listing_Standard.Gap();
