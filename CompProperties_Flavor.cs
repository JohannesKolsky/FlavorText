...
public class CompProperties_Flavor : CompProperties
{
    ...
    internal readonly List<FlavorCategoryDef> defaultGhostExcludedCategories = [FlavorCategoryDef.Named("FT_Meat_Human"), FlavorCategoryDef.Named("FT_Meat_Insect"), FlavorCategoryDef.Named("FT_Fungus"), FlavorCategoryDef.Named("FT_AnimalFoods")];
